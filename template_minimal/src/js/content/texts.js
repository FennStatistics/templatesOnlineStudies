...
EvaluateInformation: `
 <header>
     <h2>Evaluate the Video</h2>
 </header>
 
 <main class="content-horizontal-center content-vertical-center">
     <div class="w-xl text-justify">
Please rate the presentation and the topic presented in the video on the basis of the given adjectives. To do this, move the slider from does not apply at all to applies completely.

<br>
<form id="page-form">

            <!-- Question 1: Design of the video (exciting, entertaining, boring) -->
            <div class="page-item">
                <p class="text-left font-weight-bold">I found the design of the "video"...</p>
                <label for="excitingSlider" class="text-left">Exciting</label>
                <div class="slider-container">
                    <input type="range" id="excitingSlider" name="exciting" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
                        <span>3 - Neutral</span>
                        <span>4</span>
                        <span>5</span>
                        <span>Applies completely</span>
                    </div>
                </div>

                <label for="entertainingSlider" class="text-left">Entertaining</label>
                <div class="slider-container">
                    <input type="range" id="entertainingSlider" name="entertaining" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
                ...
                <label for="boringSlider" class="text-left">Boring</label>
                <div class="slider-container">
                    <input type="range" id="boringSlider" name="boring" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
            ...
            <!-- Question 2: Design of the video (useful, unnecessary, unimportant) -->
            <div class="page-item">
                <p class="text-left font-weight-bold">I found the design of the "video"...</p>
                <label for="usefulSlider" class="text-left">Useful</label>
                <div class="slider-container">
                    <input type="range" id="usefulSlider" name="useful" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
                ...
                <label for="unnecessarySlider" class="text-left">Unnecessary</label>
                <div class="slider-container">
                    <input type="range" id="unnecessarySlider" name="unnecessary" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
                ...
                <label for="unimportantSlider" class="text-left">Unimportant</label>
                <div class="slider-container">
                    <input type="range" id="unimportantSlider" name="unimportant" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
            ...
            <!-- Question 3: Topic presented in the video (exciting, entertaining, boring) -->
            <div class="page-item">
                <p class="text-left font-weight-bold">I found the topic presented in the video...</p>
                <label for="excitingTopicSlider" class="text-left">Exciting</label>
                <div class="slider-container">
                    <input type="range" id="excitingTopicSlider" name="excitingTopic" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
                ...
                <label for="entertainingTopicSlider" class="text-left">Entertaining</label>
                <div class="slider-container">
                    <input type="range" id="entertainingTopicSlider" name="entertainingTopic" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
                ...
                <label for="boringTopicSlider" class="text-left">Boring</label>
                <div class="slider-container">
                    <input type="range" id="boringTopicSlider" name="boringTopic" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
            ...
            <!-- Question 4: Topic presented in the video (useful, unnecessary, unimportant) -->
            <div class="page-item">
                <p class="text-left font-weight-bold">I found the topic presented in the video...</p>
                <label for="usefulTopicSlider" class="text-left">Useful</label>
                <div class="slider-container">
                    <input type="range" id="usefulTopicSlider" name="usefulTopic" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
                ...
                <label for="unnecessaryTopicSlider" class="text-left">Unnecessary</label>
                <div class="slider-container">
                    <input type="range" id="unnecessaryTopicSlider" name="unnecessaryTopic" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
                ...
                <label for="unimportantTopicSlider" class="text-left">Unimportant</label>
                <div class="slider-container">
                    <input type="range" id="unimportantTopicSlider" name="unimportantTopic" min="1" max="6" value="3" class="slider">
                    <div class="slider-labels">
                        <span>Does not apply at all</span>
                        <span>1</span>
                        <span>2</span>
 ...
 <footer class="content-vertical-center content-horizontal-right">
  The "Continue" button will become active once you've interacted with all sliders:
     <button id="continue" type="submit" form="page-form">
         Continue &rarr;
     </button>
 </footer>
...
Note: You can switch to full-screen mode by double-clicking the video.
</div>
